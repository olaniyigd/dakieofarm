      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-[20%]">
            <Image
              src="/dakieologo.jpg" // Replace with your image path
              alt="Our Company"
              width={200}
              height={200}
        ...
        <div className="mt-2">
          <p className="text-gray-700 text-lg leading-relaxed text-justify text-[14px]">
...
The entrepreneur behind the vision of DAKIEO Farm is a vast agriculturist, majoring on livestock farming. As a way of practice, he has devoted most of his time and resources in rearing livestock.   Owning a first degree in Linguistics at the University of Ilorin, Ilorin, Kwara State, Nigeria. 
        ...
        <div className="mt-4">
        <p className="text-black font-[700]">THE BENEFITS OF OUR PRODUCTS AND SERVICES</p>
        <p className="text-gray-700 text-lg leading-relaxed text-justify text-[14px]">
...
Fair and best possible prices.
        ...
        <div className="mt-4">
        <p className="text-black font-[700]">VISION STATEMENT</p>
        <p className="text-gray-700 text-lg leading-relaxed text-justify text-[14px]">
        ...
        <div className="mt-4">
        <p className="text-black font-[700]">OUR MISSION </p>
        <p className="text-gray-700 text-lg leading-relaxed text-justify text-[14px]">
